...
const Login = () => {
    ...
    const { login, Salesmanlogin } = useAuth();
            ...
            <div className="row h-100">
                <div className="col-6">
                    <div className="d-flex flex-column ms-5 mt-5">
                        ...
                        {/* Form */}
                        <div className="col mt-5" style={{ width: "100%", maxWidth: "537px" }}>
                            ...
                            <Button
                                onClick={() => {
                                    if (customerCode) {
                                        login(customerCode, userCode, password);
                                    } else {
                                        Salesmanlogin(userCode, password);
                                    }
                                }}
                                variant="primary w-100 mt-4 rounded-pill"
                                type="submit"
                            >
                                Giriş
                            </Button>
                ...
                <div className="col-6 d-flex align-items-center justify-content-center shadow-lg bg-sh-primary position-relative" >
                    ...
                    <div className="col-1 w-100 h-100 d-flex align-items-center  bg-white rounded" style={{ maxWidth: "500px", maxHeight: "334px" }}>
